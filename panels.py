"""Panel UI for Canto Connector following UI_INTERFACE_STANDARD.md and AUTH_AND_CREDENTIALS_STANDARD.md."""
...
def _settings_button() -> ui.UINode:
    return ui.Button(
        ...
        size="sm",
        icon="settings",
        on_click=ui.Call("__panel__canto_settings")
    )

def _help_modal() -> ui.UINode:
    return ui.Modal(
        trigger=ui.Button("How do I set this up?", variant="ghost", size="sm"),
        title="Connecting Canto",
        children=[
            ui.Text(
                "1. Sign in to your Canto account and navigate to Security or User Settings.\n2. Choose your preferred authentication method (OAuth SSO, API Key / Token, or Username & Password Basic Auth).\n3. Enter your credentials and click Connect.",
                variant="body"
            )
        ]
    )

@ext.panel("canto_sidebar", slot="left")
async def canto_sidebar(ctx, **kwargs) -> ui.UINode:
    return ui.Stack(
        direction="v",
        gap=3,
        align="stretch",
        children=[
            ui.Text("Canto", variant="heading"),
            ui.Stack(
                direction="v",
                gap=1,
                align="stretch",
                children=[
                    ui.Text("Manage your Canto connections and integrations.", variant="caption"),
                ]
            ),
            ui.Divider(),
            ui.Stack(
                ...
                children=[
                    ...
                    ui.Form(
                        submit_label="Connect Canto",
                        action=ui.Call("connect_canto"),
                        children=[
                            ui.Stack(
                                direction="v",
                                gap=2,
                                ...
                                children=[
                                    ...
                                    ui.Stack(
                                        ...
                                        children=[
                                            ...
                                            ui.Input(param_name="label", placeholder="e.g. Production Canto"),
                                        ]
                                    ),
                                    ui.Stack(
                                        direction="v",
